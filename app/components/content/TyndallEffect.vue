...
<template>
    <div
        ...
        <div class="streak flex-none mix-blend-overlay overflow-hidden pointer-events-none absolute w-[200%] lg:w-[150%] h-12 lg:h-24 left-[-60vw] top-[40vw] lg:left-[-32vw] lg:top-[24vw] xl:left-[-12vw] xl:top-[17vw]"
            ...
            :enter="{ opacity: 0.92, rotate: '35deg', scaleY: 1 }" :duration="2000" />
        <div class="streak flex-none mix-blend-overlay overflow-hidden pointer-events-none absolute w-[200%] lg:w-[150%] h-12 lg:h-24 left-[-60vw] top-[40vw] lg:left-[-32vw] lg:top-[24vw] xl:left-[-12vw] xl:top-[17vw]"
            v-motion :initial="{ opacity: 0, rotate: '46deg', scaleY: 0.5 }"
            :enter="{ opacity: .8, rotate: '38deg', scaleY: 1 }" :duration="2000" />
        <div class="streak flex-none mix-blend-overlay overflow-hidden pointer-events-none absolute w-[200%] lg:w-[150%] h-12 lg:h-24 left-[-60vw] top-[40vw] lg:left-[-32vw] lg:top-[24vw] xl:left-[-12vw] xl:top-[17vw]"
            v-motion :initial="{ opacity: 0, rotate: '58deg', scaleY: 0.5 }"
            :enter="{ opacity: .6, rotate: '30deg', scaleY: 1 }" :duration="2000" />
        <div class="streak flex-none mix-blend-overlay overflow-hidden pointer-events-none absolute w-[200%] lg:w-[150%] h-20 lg:h-48 left-[-32vw] top-[32vw] lg:left-[-12vw] lg:top-[18vw] xl:left-[-10vw] xl:top-[10vw]"
            v-motion :initial="{ opacity: 0, rotate: '54deg', scaleY: 0.5 }"
            :enter="{ opacity: .8, rotate: '35deg', scaleY: 1 }" :duration="2000" />
...
.sui-tyndall-effect {
    --streak-color: rgba(0, 0, 0, 0.507);
}

.dark .sui-tyndall-effect {
    --streak-color: hsla(0, 0%, 100%, 0.219);
}
